...
class FlagsmithClient {
  ...
  Future<bool> hasFeatureFlag(String featureName, {Identity? user}) async {
    ...
    var feature = features.firstWhereOrNull((element) => element.feature.name == featureName && element.enabled == true);
  ...
  Future<bool> isFeatureFlagEnabled(String featureName, {Identity? user}) async {
    var features = await getFeatureFlags(user: user, reload: false);
    var feature = features.firstWhereOrNull((element) => element.feature.name == featureName);
    _incrementFlagAnalytics(feature);
  ...
  Future<String?> getFeatureFlagValue(String featureId, {Identity? user}) async {
    var features = await getFeatureFlags(user: user, reload: false);
    var feature = features.firstWhereOrNull((element) => element.feature.name == featureId);
    _incrementFlagAnalytics(feature);
